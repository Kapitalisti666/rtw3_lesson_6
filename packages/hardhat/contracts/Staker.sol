...
contract Staker {
  ...
  address public _to = address(this);
  ...
  */
  ...
  function sendValueToStakeContract() public payable {
  ...
  */
  function withdraw() public withdrawalDeadlineReached(true) claimDeadlineReached(false) notCompleted{
    ...
    uint256 indBalanceRewards = individualBalance + ((block.timestamp-depositTimestamps[msg.sender])**2)*rewardRatePerSecond;
