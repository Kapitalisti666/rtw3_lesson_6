      ...
      <BrowserRouter>
        ...
        <Switch>
          <Route exact path="/">
            ...
            <div>
              <input type="text" name="value" value ={value} placeholder="Insert stake amount" onChange={(e) => {setValue(e.target.value)}}/>
            </div>
            <div style={{ padding: 8 }}>
              <Button
                type={balanceStaked ? "success" : "primary"}
                onClick={() => {
                  tx(writeContracts.Staker.stake({ value: ethers.utils.parseEther(value)}));
                  setValue("");
                }}
              >
                🥩 Stake ether!
            ...
            <div>
              <input type="text" name="topup" value ={topup} placeholder="Insert top up amount" onChange={(e) => {topUp(e.target.value)}}/>
            </div>
            <div style={{ padding: 8 }}>
              <Button
                onClick={() => {
                  tx(writeContracts.Staker.sendValueToStakeContract({ value: ethers.utils.parseEther(topup)}));
                  topUp("");
                }}
              >
                Top up contract!
